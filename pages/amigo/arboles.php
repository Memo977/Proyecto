...
$trees = getTreesByFriend($_SESSION['user_id']);
?>
<!DOCTYPE html>
<html lang="es">
...
<body>
    ...
    <div class="container">
        ...
        <div class="alert alert-info">
            ...
            <a href="arboles_disponibles.php" class="alert-link">¡Adquiere tu primer árbol aquí!</a>
        </div>
        <?php else: ?>
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            <div class="col">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><?php echo htmlspecialchars($tree['nombre_comercial']); ?>
                        </h5>
                        <p class="card-text">
                        ...
                        <p class="card-text">
                            ...
                            <span class="badge bg-success"><?php echo htmlspecialchars($tree['estado']); ?></span>
                        </p>
                    </div>
                    <div class="card-footer border-top-0">
                        <div class="d-grid gap-2">
                            <a href="detallesArbol.php?id=<?php echo $tree['id']; ?>" class="btn btn-primary">
